...
export let options = {
    scenarios: {
        create_test: {
            ...
            stages: [
                { target: 1157, duration: '10s' },   // 5분 동안 1157 req/sec까지 ramp-up
                { target: 1157, duration: '10s' },  // 10분간 유지
                { target: 0, duration: '10s' },      // 5분 동안 ramp-down
            ],
        },
    },
};
...
export default function () {
    const endpoint = 'http://host.docker.internal:8080/url/create';
